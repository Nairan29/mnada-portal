...
<link rel="stylesheet" href="css portal/navbar.css">
<link href="Boostrap/portal.css" rel="stylesheet" id="bootstrap-css">
    ...
    <div class="container">
        <div class="row row1">
            <ul class="largenav pull-right">
                ...
                <li class="upper-links dropdown"><a class="links" href="http://clashhacks.in/">Logout</a>
